        ...
        <el-tab-pane label="基本信息">
          <el-card>
            <div class="info-section">
              ...
              <h2>时间节点</h2>
              <p v-if="plant.timeNode">
                <el-tag>{{ plant.timeNode.name }}</el-tag>
                <span class="period-tag">{{ plant.timeNode.period }}</span>
              </p>
              <p v-else>未知时间节点</p>
    ...
    <el-dialog v-model="dialogVisible" title="添加养护记录" width="30%">
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button type="primary" @click="addCareRecord">确定</el-button>
        </span>
      </template>
    </el-dialog>
  </div>
...
import { getUserPlantCareRecords, addCareRecord, deleteCareRecord } from '../api/careRecords';
